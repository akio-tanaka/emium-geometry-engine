...
/**
* @brief add functions as UI functions to calculate curvature
* @param viewer [in] viewer
* @param V [in] vertices
* @param F [in] faces
* @param adjacency_list [in] adjacency list
* @param curvature_info [in] curvature information
*/
